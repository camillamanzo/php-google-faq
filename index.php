...
<?php 
    $questions = [
        ...
        "response" => "<p>The recent ruling by the Court of Justice of the European Union has profound consequences for search engines in Europe. The court found that certain users have the right to ask search engines like Google to remove results for queries that include the person's name. To qualify, the results shown would need to be inadequate, irrelevant, no longer relevant, or excessive.
            </p>
            <p>
        ...
        "response" => "<p>We know that security and privacy are important to you - and they are important to us, too. We make it a priority to provide strong security and give you confidence that your information is safe and accessible when you need it.
            </p>
            <p>
            ...
            <p>
            Find out more about how we keep your personal information private and safe – and put you in control.</p>",
        ],


        ["question" => "Why is my account associated with a country?",
        "response" => "<p>Your account is associated with a country (or territory) in the Terms of Service so that we can determine two things
            <ol>
            ...
            <p>        
            <h5 class='mt-5'>Determining the country associated with your account</h5>
            </p>
            <p> 
    ...
    <div class="container">
        <div class="row">
            <section class="col-8 mx-auto mt-5">
                ...
                <h2 class="my-3"><?php echo $element["question"]; ?></h2>
